...
public class NonMemberAdapter extends RecyclerView.Adapter<NonMemberAdapter.ViewHolder> {
    ...
    // constructor
    public NonMemberAdapter(ArrayList<Society> cursorUserArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.non_user_societylist, parent, false);
...
//        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            userName = itemView.findViewById(R.id.societynonUserList);
            userSocietyId = itemView.findViewById(R.id.nonuser_societyId);
        }
    }
}
